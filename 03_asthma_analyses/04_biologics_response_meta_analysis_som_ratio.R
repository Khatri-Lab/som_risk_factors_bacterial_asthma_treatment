...
###############################################################
som_summary <- obtain_meta_analysis_summary(responder_meta_obj, "som_score_ratio", "SoM")
...
write_csv(main_fig_summary, "/labs/khatrilab/ananthg/detrimental_host_response/data_2024_09_27/asthma_biologics_meta_analysis_main_fig_summary_som_ratio.csv")
write_csv(supp_fig_summary, "/labs/khatrilab/ananthg/detrimental_host_response/data_2024_09_27/asthma_biologics_meta_analysis_supp_fig_summary_som_ratio.csv")
###############################################################
