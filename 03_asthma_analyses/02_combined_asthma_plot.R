...
aligned_supp_fig <- cowplot::align_plots(GSE69683_module_1_plot, GSE69683_module_2_plot, GSE69683_module_3_plot, GSE69683_module_4_plot, GSE96530_module_1_plot, GSE96530_module_2_plot, GSE96530_module_3_plot, GSE96530_module_4_plot, align = "hv", axis = "tblr")
###############################################################
...
###############################################################
cairo_pdf("/labs/khatrilab/ananthg/detrimental_host_response/figures_2024_09_27/fig_S3_combined_asthma.pdf", width = 7, height = 3, bg = "transparent")

pushViewport(viewport(layout = grid.layout(nrow = 67, ncol = 100)))

print(as_ggplot(aligned_supp_fig[[1]]), vp = viewport(layout.pos.row = 1:30, layout.pos.col = 1:25))
print(as_ggplot(aligned_supp_fig[[2]]), vp = viewport(layout.pos.row = 1:30, layout.pos.col = 26:50))
print(as_ggplot(aligned_supp_fig[[3]]), vp = viewport(layout.pos.row = 1:30, layout.pos.col = 51:75))
print(as_ggplot(aligned_supp_fig[[4]]), vp = viewport(layout.pos.row = 1:30, layout.pos.col = 76:100))
print(as_ggplot(aligned_supp_fig[[5]]), vp = viewport(layout.pos.row = 35:64, layout.pos.col = 1:25))
print(as_ggplot(aligned_supp_fig[[6]]), vp = viewport(layout.pos.row = 35:64, layout.pos.col = 26:50))
print(as_ggplot(aligned_supp_fig[[7]]), vp = viewport(layout.pos.row = 35:64, layout.pos.col = 51:75))
print(as_ggplot(aligned_supp_fig[[8]]), vp = viewport(layout.pos.row = 35:64, layout.pos.col = 76:100))

print(GSE69683_legend, vp = viewport(layout.pos.row = 31:33, layout.pos.col = 1:100))
print(GSE96530_legend, vp = viewport(layout.pos.row = 65:67, layout.pos.col = 1:100))

grid.text(x = unit(0.015, "npc"), y = unit(0.975, "npc"), label = "A", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.015, "npc"), y = unit(0.4675, "npc"), label = "B", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
