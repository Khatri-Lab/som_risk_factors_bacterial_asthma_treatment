...
combined_score_pheno <- cbind(GSE88794_with_module_scores$pheno, t(GSE88794_with_module_scores$expr[c("module_1_score", "module_2_score", "module_3_score", "module_4_score", "detrimental_score", "protective_score", "som_score", "som_score_ratio", "tsang_ihm_score", "tsang_up_score", "tsang_down_score"), ]))
