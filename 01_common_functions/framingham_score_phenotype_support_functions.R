...
###############################################################
genes_mod_1 <- c("NQO2", "SLPI", "ORM1", "KLHL2", "ANXA3", "TXN", "AQP9", "BCL6", "DOK3", "PFKFB4", "TYK2")#11
genes_mod_2 <- c("BCL2L11", "BCAT1", "BTBD7", "CEP55", "HMMR", "PRC1", "KIF15", "CAMP", "CEACAM8", "DEFA4", "LCN2", "CTSG", "AZU1")#13
genes_mod_3 <- c("MAFB", "OASL", "UBE2L6", "VAMP5", "CCL2", "NAPA", "ATG3", "VRK2", "TMEM123", "CASP7")#10
genes_mod_4 <- c("DOK2", "HLA-DPB1", "BUB3", "SMYD2", "SIDT1", "EXOC2", "TRIB2", "KLRB1")#8
...
combine_module_scores <- function(gene_expr_matrix)
{
  ...
  score_matrix$som_score_ratio <- score_matrix$detrimental_score / score_matrix$protective_score
