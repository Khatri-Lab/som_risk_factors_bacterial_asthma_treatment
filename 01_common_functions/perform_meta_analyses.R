...
keep_signature_mod_genes <- function(dataset)
{
  ...
  rownames(new_expr)[(original_expr_rows + 1): nrow(new_expr)] <- c("detrimental_score", "protective_score", "som_score", "tsang_ihm_score")
  new_keys <- c(dataset$keys, "module_1_score", "module_2_score", "module_3_score", "module_4_score", "tsang_up_score", "tsang_down_score", "detrimental_score", "protective_score", "som_score", "tsang_ihm_score")
  names(new_keys) <- c(names(dataset$keys), "module_1_score", "module_2_score", "module_3_score", "module_4_score", "tsang_up_score", "tsang_down_score", "detrimental_score", "protective_score", "som_score", "tsang_ihm_score")
