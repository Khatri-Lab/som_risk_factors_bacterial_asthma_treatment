...
library(plyr)
library(tidyverse)
list_of_scores <- c("som_score", "detrimental_score", "protective_score", "module_1_score", "module_2_score", "module_3_score", "module_4_score")
...
###############################################################
saveRDS(list(eff_size_matrix = eff_size_matrix, fdr_matrix = fdr_matrix, combined_summary = combined_summary), file = "/labs/khatrilab/ananthg/detrimental_host_response/data_2024_09_27/case_control_analysis_summary.rds")
write_csv(combined_eff_size, file = "/labs/khatrilab/ananthg/detrimental_host_response/data_2024_09_27/meta_analyses_effect_sizes.csv")
write_csv(combined_summary, file = "/labs/khatrilab/ananthg/detrimental_host_response/data_2024_09_27/meta_analyses_data_summary.csv")
write_csv(data_summary, file = "/labs/khatrilab/ananthg/detrimental_host_response/data_2024_09_27/meta_analyses_individual_dataset_summary.csv")
###############################################################
