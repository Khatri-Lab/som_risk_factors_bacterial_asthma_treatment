...
print(as_ggplot(aligned_main_fig[[1]]), vp = viewport(layout.pos.row = 2:22, layout.pos.col = 55:75))
print(as_ggplot(aligned_main_fig[[2]]), vp = viewport(layout.pos.row = 23:43, layout.pos.col = 55:75))
print(as_ggplot(aligned_main_fig[[3]]), vp = viewport(layout.pos.row = 47:68, layout.pos.col = 1:18))
print(as_ggplot(aligned_main_fig[[4]]), vp = viewport(layout.pos.row = 47:68, layout.pos.col = 19:36))
print(as_ggplot(aligned_main_fig[[5]]), vp = viewport(layout.pos.row = 47:68, layout.pos.col = 38:56))
print(as_ggplot(forest_plot), vp = viewport(layout.pos.row = 51:69, layout.pos.col = 57:74))
...
grid.rect(x = unit(0.5, "npc"), y = unit(0.35, "npc"), width = unit(0.99, "npc"), height = unit(0.025, "npc"), gp = gpar(fill = "#EFEFEF", col = "transparent"))
...
grid.text(x = unit(0.5, "npc"), y = unit(0.35, "npc"), label = "Hydrocortisone treatment response in Burn and VANISH cohorts", gp = gpar(fontsize = base_text_size, fontface = "plain", col = black_text_colour))
grid.text(x = unit(0.875, "npc"), y = unit(0.28, "npc"), label = "Hydrocortisone vs. placebo\nin protective \U2265 median", gp = gpar(fontsize = base_text_size, fontface = "plain", col = black_text_colour))

grid.text(x = unit(0.01, "npc"), y = unit(0.96, "npc"), label = "A", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.73, "npc"), y = unit(0.96, "npc"), label = "B", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.73, "npc"), y = unit(0.69, "npc"), label = "C", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.01, "npc"), y = unit(0.32, "npc"), label = "D", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.25, "npc"), y = unit(0.32, "npc"), label = "E", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.50, "npc"), y = unit(0.32, "npc"), label = "F", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.76, "npc"), y = unit(0.32, "npc"), label = "G", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
...
cairo_pdf("/labs/khatrilab/ananthg/detrimental_host_response/figures_2024_09_27/fig_S1_combined_bacterial.pdf", width = 8, height = 5, bg = "transparent")

pushViewport(viewport(layout = grid.layout(nrow = 100, ncol = 100)))

print(as_ggplot(aligned_supp_fig[[1]]), vp = viewport(layout.pos.row = 1:48, layout.pos.col = 1:40))
print(bacterial_plot_legend, vp = viewport(layout.pos.row = 1:48, layout.pos.col = 41:60))
print(as_ggplot(aligned_supp_fig[[2]]), vp = viewport(layout.pos.row = 1:48, layout.pos.col = 61:100))
print(as_ggplot(aligned_supp_fig[[3]]), vp = viewport(layout.pos.row = 49:97, layout.pos.col = 1:20))
print(as_ggplot(aligned_supp_fig[[4]]), vp = viewport(layout.pos.row = 49:97, layout.pos.col = 21:40))
print(as_ggplot(aligned_supp_fig[[5]]), vp = viewport(layout.pos.row = 49:97, layout.pos.col = 41:60))
print(as_ggplot(aligned_supp_fig[[6]]), vp = viewport(layout.pos.row = 49:97, layout.pos.col = 61:80))
print(as_ggplot(aligned_supp_fig[[7]]), vp = viewport(layout.pos.row = 49:97, layout.pos.col = 81:100))
print(hydrocortisone_legend, vp = viewport(layout.pos.row = 99:100, layout.pos.col = 1:100))

grid.text(x = unit(0.02, "npc"), y = unit(0.985, "npc"), label = "A", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.61, "npc"), y = unit(0.985, "npc"), label = "B", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.01, "npc"), y = unit(0.5, "npc"), label = "C", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.21, "npc"), y = unit(0.5, "npc"), label = "D", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.41, "npc"), y = unit(0.5, "npc"), label = "E", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.61, "npc"), y = unit(0.5, "npc"), label = "F", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
grid.text(x = unit(0.81, "npc"), y = unit(0.5, "npc"), label = "G", gp = gpar(fontsize = base_text_size + 2, fontface = "bold", col = black_text_colour))
